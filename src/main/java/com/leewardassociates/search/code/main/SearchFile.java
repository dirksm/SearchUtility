...
/**
 * The Class SearchFile.
 *
 * @author Michael R Dirks
 */
public class SearchFile {

	private static Logger log = LoggerFactory.getLogger(SearchFile.class);
	...
	public static void main(String[] args) {
		/**
		 * Pseudo code:
		 * 1. Load missing table spreadsheet
		 * 2. Load spreadsheet to search
		 * 3. Remove tables found from missing table spreadsheet
		 * 4. Create new spreadsheet with updated list
		 */
		processInputs(args);
		try {
			searchFile();			
